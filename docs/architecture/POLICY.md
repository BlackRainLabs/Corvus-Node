...
**Related Documents:** OVERVIEW.md, AGENT-WORKFLOW.md, OPERATIONS.md, CHANGES.md, AVAILABLE.md
...
v0.1.9. Filter, principal, hop MAC, and default-deny chat live in **Node**. This is not a bolt-on.
